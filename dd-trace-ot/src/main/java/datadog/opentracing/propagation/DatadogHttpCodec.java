...
public class DatadogHttpCodec {
  ...
  public static class Injector implements datadog.opentracing.propagation.Injector {
  ...
  public static class Extractor implements datadog.opentracing.propagation.Extractor {
