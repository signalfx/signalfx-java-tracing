...
public final class HandlerInstrumentation extends Instrumenter.Default {
  ...
  public String[] helperClassNames() {
    return new String[] {
      "datadog.trace.instrumentation.jetty6.HttpServletRequestExtractAdapter",
      "datadog.trace.instrumentation.jetty6.HttpServletRequestExtractAdapter$MultivaluedMapFlatIterator",
    };
  }
